...
function Service() {
	const leftCard= [
			...
			["Pricing & Negotiating","We may negotiate prices, but there are some lines that I will not allow to be crossed. Please keep in mind that pricing has been formed with certain criteria based on the time and effort certain components need so they can be developed. The minimum price is the minimum price. I am not going to discuss cheap alternatives as they already exist here and there. I do not make quality cuts, and therefore my minimum is set where it is set. With that being said, I am willing to hear your needs and your approach and will try to keep prices as close to the minimum as possible. I want you, at the end of the process, to be satisfied both in quality and monetary terms. Therefore, I will discuss with you as much as needed to negotiate the price."],
			...
			["Maintenance Rules","The maintenance annual plan covers two (2) service rounds, one (1) every six (6) months approximately. Those service rounds include updates on content (such as the addition of images or displayed products) and fixes on misbehaving components. The service is concerned only with existing components and elements. Thus, adding new functionalities is not included in this annual plan. <br/><br/>Anyone other than me altering the code will result in the nullification of the annual plan and no refund will be given to you. <br/><br/>If your aim is to add functionality, you will have to pay for the development and you will have to negotiate a price for that."]
		];
	const rigthCard= [
			["Basic Small Business Website"," A small business website requires a minimum level of complexity. It cannot have a login or registering mechanisms, nor can it have a connection with a database. Also, you cannot get email notifications from this website. Other features are negotiable. Less complexity means that you get a cheaper price. My promise to you is that you will get what you paid for, if not more.","1500$ minimum"],
			["Annual Maintenance","The above pricing is subject to change as the years advance and you can renew, negotiate, or stop requiring this service at any year. It is optional. What does it include? It includes two (2) major maintenance service rounds, one (1) approximately every six (6) months. Those maintenance rounds include changes in content or fixes to the existing components. If you want to add functionalities that do not already exist or require more maintenance rounds, you will be needing to negotiate a price. If the website has been altered by anyone other than me, this option is not available anymore.","200$ per year"],
			...
			["Deployment","This will be determined by the cost of acquiring a domain for your website and for the expenses of hosting it. I am asking for this because I will deploy it for you and that will cover the first year. Afterwards the deployment cost will become your responsibility. I will explain to you personally how you can take care of them. I will show you the price of both domain and hosting and we will find out the details together. I will only proceed to deploy your website after we have agreed on the terms and details of the deployment.","Less than 60$ (once)"],
